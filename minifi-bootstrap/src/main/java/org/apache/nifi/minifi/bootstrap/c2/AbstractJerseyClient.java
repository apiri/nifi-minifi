...
public abstract class AbstractJerseyClient {
     ...
     * @throws MiNiFiC2Exception if any exception other than IOException is encountered
     * @throws IOException           if an I/O error occurs communicating with the registry
     */
    protected <T> T executeAction(final String errorMessage, final MiNiFiC2Action<T> action) throws MiNiFiC2Exception, IOException {
        try {
            ...
            if (ioeCause == null) {
                ...
                throw new MiNiFiC2Exception(errorMessageBuilder.toString(), e);
            } else {
