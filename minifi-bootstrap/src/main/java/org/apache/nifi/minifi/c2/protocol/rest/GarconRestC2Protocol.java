...
public class GarconRestC2Protocol extends RestC2Protocol {
    ...
    public static final int DEFAULT_C2_SERVER_PORT = 10080;

    //    private MiNiFiC2Client c2Client = new JerseyMiNiFiC2Client();
    protected static final String API_ENDPOINT = "c2/api/c2-protocol/heartbeat";
    ...
    @Override
    public C2Payload transmit(final C2Payload payload) throws MiNiFiC2Exception {
        ...
        try (final Response response = httpClient.newCall(request).execute()) {
            ...
            if (payload.isRaw()) {
                ...
                responsePayload = new C2Payload(payload.getOperation(), payload.getIdentifier(), true, false);
            }
            return responsePayload;
        } catch (Exception e) {
            logger.error("Unable to successfully execute request", e);
            throw new MiNiFiC2Exception("Could not successfully perform request", e);
        }
    }
