...
/**
 * Configuration for a {@link MiNiFiC2Client}.
 */
public class MiNiFiC2ClientConfig {
    ...
    private MiNiFiC2ClientConfig(final Builder builder) {
    ...
    public static class Builder {
        ...
        public MiNiFiC2ClientConfig build() {
            return new MiNiFiC2ClientConfig(this);
        }
    }
} 